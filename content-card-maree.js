...
window.customCards.push({
  type: "content-card-maree",
  name: "Carte Maree par saniho",
  description: "Carte pour l'intégration mareeInfo.",
  preview: true,
  documentationURL: "https://github.com/saniho/content-card-maree",
});
